...
const StatsCard = ({ label, value, icon, color, isLarge }) => {
  return (
    <main className="bg-[#161617] border border-white/5 p-5 sm:p-6 rounded-3xl flex flex-col items-center justify-center text-center hover:scale-105 hover:border-[#D4AF37]/20 transition-all duration-300 cursor-default">
